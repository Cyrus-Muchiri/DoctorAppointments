...
const nav: NavItem[] = [
  { name: 'Doctors Appointments',        icon: NumberedListIcon,           to: '/doctors/dashboard' },
...
<template>
  ...
  >
    ...
    <!-- Collapse button -->
    <button
      class="h-12 flex items-center justify-center hover:bg-teal-700"
      @click="isOpen = !isOpen"
    >
      <svg
        :class="['h-6 w-6 transition-transform', isOpen ? '' : 'rotate-180']"
